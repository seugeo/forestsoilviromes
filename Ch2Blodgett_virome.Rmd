...
ggsave("C:/Users/segeo/Box Sync/EmersonLab/Research/Ch2Blodgett/R_Figures/pdf/BoxPlots/DNAyield/Blodgett_0_DNAyield.pdf", width = 200, height = 120, units = "mm", dpi = 500)
...
ggplot(firm_d, aes(x = Comp.1, y = RelAbd)) +
  ...
  labs(title = "Scatter Plot",
       x = "Burn Severity",
       y = "Relative Abundance of Firmicutes") +
  theme_minimal()
...
ggplot(actino_d, aes(x = Comp.1, y = RelAbd)) +
  ...
  labs(title = "Scatter Plot",
       x = "Burn Severity",
       y = "Relative Abundance of Actinobacteriota") +
  theme_minimal()

cor.test(actino_d$Comp.1, firm_d$RelAbd, method = "spearman")
