...
d.otu.phylum.long <- pivot_longer(d.otu.rel.phylum, cols=2:28, names_to = "ID", values_to = "RelAbd")
...
# Prep data frame for plotting
d.otu.phylum.map <- merge(d.otu.phylum.stack, d.map.pc1, by="ID")
