...
bd.asv.pcoa.points <- rownames_to_column(bd.asv.pcoa.points, var ="MapID")
bd.asv.map=left_join(bd.asv.pcoa.points,bd_map.pc1,by="MapID")
...
ggplot(bd.asv.map, aes(x=pcoa1, y=pcoa2, color=Plot))+
  ...
  labs(x = "28.26% Variance Explained", 
       y = "16.68% Variance Explained",
