...
ggsave("C:/Users/segeo/Box Sync/EmersonLab/Research/Ch2Blodgett/R_Figures/pdf/PCA/All_PCA_princomp.pdf", width = 200, height = 125, units = "mm", dpi = 500)
```
...
# Soil Moisture
```{r}
ggplot(b.metadata, aes(x = Timepoint, y = Moisture, fill = Treatment)) +
